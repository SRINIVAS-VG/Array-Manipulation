...
function concatenateArray() {
    const example = [
        { name: "anu", age: 24, profession: "developer" },
        { name: "ram", age: 29, profession: "admin" },
        { name: "suman", age: 28, profession: "admin" }];
    for (let i = 0; i < example.length; i++) {
        data.push(example[i])
    }
    console.log("Concatenation of Arrays is Successfully executed");
}
